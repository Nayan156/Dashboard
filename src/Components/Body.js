...
import { dataSet, dataBullet, CSPM, CWPP, Registory } from "../utils/data";
    ...
    return(
        <div className="body bg-slate-100 h-full w-screen pl-10 pr-1 pb-4">
            ...
            <div className="flex pr-4">
                ...
                <button className="border-[1.5px] border-slate-300 rounded-md px-1 mx-2 bg-white text-slate-500">
            ...
            <div className="widget-container flex gap-2 overflow-x-scroll no-scrollbar py-3">
                {CSPM.data.map((value)=> <div key={value.id}><WidgetCard dataValue={value}/></div>)}
            ...
            <div className="widget-container flex gap-2 overflow-x-scroll no-scrollbar py-3">
                {CWPP.data.map((value)=> <div key={value.id}><WidgetCard dataValue={value}/></div>)}
