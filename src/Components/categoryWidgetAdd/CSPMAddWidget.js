...
const CSPMAddWidget = () =>{
    ...
    const postWidget = async (object) =>{
        try{
            const result = await axios.post('http://localhost:3000/CSPM',object);
    ...
    const deleteWidget = async (data) => {
        const result = await axios.delete('http://localhost:3000/CSPM/'+data.id);
    ...
    const handleChangeVissible = async (data) => {
        const result = await axios.put('http://localhost:3000/CSPM/'+data.id, {
            ...data,
